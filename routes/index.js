...
router.get('/logged/home/', function(req, res, next) {
    if (master) {
        var m = false;
        var a = false;
        var e = false;
        ...
        info.once("value", function(snapshot) {
            if (snapshot.val() != null) {
                ...
                if (flag = 0) {
                    ...
                    res.render('index', { title: 'Balaji Transports', date: date, info: details, morning: m, afternoon: a, evening: e, empty: false });
                }
            } else {
